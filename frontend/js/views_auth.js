...
const Auth = (() => {
    ...
    app().innerHTML = `<div class="container py-4"><div class="row justify-content-center"><div class="col-lg-8">
      ...
      <form onsubmit="Auth.submitEvent(event)">
        ...
        <div class="wiz-step d-none" data-step="4">
          ...
          <div class="mb-3"><label class="form-label">Banner image URL (optional)</label><input id="eBanner" class="form-control" placeholder="https://..."></div>
  ...
  return { login, submitLogin, register, submitRegister, createEvent, wizNav, submitEvent, saved, _step: 1 };
})();
